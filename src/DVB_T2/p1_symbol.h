...
{
    Q_OBJECT
    friend class P1AcquisitionTest;

public:
    explicit p1_symbol(QObject *parent = nullptr);
    ~p1_symbol() override;

    void restart(){reset_buffer();p1_buffer.reset();cor_buffer.reset();consume_p1=0;idx_fq_shift=0;p1_decoded=false;}
...
private:
    ...
    int consume_p1 = 0;
    int idx_fq_shift = 0;
    sum_of_buffer<float, P1_B_PART> energy_now, energy_delayed;
    int idx_buffer = 0;
    float correlation = 0;
