...
data_symbol::~data_symbol()
{
    if(est_show != nullptr){
        delete [] buffer_cell;
        delete [] deinterleaved_buffer_a;delete [] deinterleaved_buffer_b;
        delete [] est_show;
        delete [] show_symbol;
        delete [] show_data;
                       ...
                       address_freq_deinterleaver* _address)
{
    ...
    delete[] buffer_cell;delete[] deinterleaved_buffer_a;delete[] deinterleaved_buffer_b;
    delete[] est_show;delete[] show_symbol;delete[] show_data;delete[] show_est_data;
...
//            angle = atan2_approx(est_pilot.imag(), est_pilot.real());
            ...
            if(dif_angle > M_PIf32) dif_angle -= M_PIf32 * 2.0f;
