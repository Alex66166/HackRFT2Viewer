...
private:
    ...
    int* h_even_data;
    int* h_odd_data;
    complex* buffer_cell = nullptr;        // max(dx) x max(dy) x 2 for scaterred pilot pattern
    complex* deinterleaved_buffer_a = nullptr;
    complex* deinterleaved_buffer_b = nullptr;
